...
interface TravelImpactCalculatorProps {
  distance: string;
  setDistance: (distance: string) => void;
  transportMode: string;
  setTransportMode: (mode: string) => void;
  calculateCarbonFootprint: (distance: string, mode: string) => string;
}

const TravelImpactCalculator = ({
  distance,
  setDistance,
  transportMode,
  setTransportMode,
  calculateCarbonFootprint,
}: TravelImpactCalculatorProps) => {
  return (
...
export default TravelImpactCalculator;
